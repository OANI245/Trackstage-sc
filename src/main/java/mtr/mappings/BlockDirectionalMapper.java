...
import berries.mods.ts.mvapi.MVSimpleCodecHorizontalDirectionalBlock;
import net.minecraft.core.BlockPos;
import net.minecraft.server.level.ServerLevel;
import net.minecraft.util.RandomSource;
import net.minecraft.world.level.block.state.BlockState;

public abstract class BlockDirectionalMapper extends MVSimpleCodecHorizontalDirectionalBlock {
    protected BlockDirectionalMapper(Properties properties) {
        super(properties);
    }
